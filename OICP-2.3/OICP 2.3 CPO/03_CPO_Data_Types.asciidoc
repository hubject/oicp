...
[[EvseStatusByOperatorIDResponseType]]
=== EvseStatusByOperatorIDResponseType
[%header,format=dsv, cols=5]
|=====================
Name:Data Type:Description:M/O
OperatorEvseStatus:<<OperatorEvseStatusType,OperatorEvseStatusType>>:OperatorEvseStatus list:M  0...n:
|=====================

[[EvseStatusByIDResponseType]]
=== EvseStatusByIDResponseType
[%header,format=dsv, cols=5]
|=====================
Name:Data Type:Description:M/O
