...
= [[codeSnippets]]Code Snippets (Release Candidate)

IMPORTANT: All the values provided in this Code Snippets are demonstration purposes.

== [[eRoamingPushEvseData]]eRoamingPushEvseData
...
== [[eRoamingPushEVSEStatus]]eRoamingPushEVSEStatus
...
== [[ChargeDetailRecord]]eRoamingChargeDetailRecord
...
== [[RemoteReservationStart]]eRoamingRemoteReservationStart
...
== [[RemoteReservationStop]]eRoamingRemoteReservationStop
...
== [[PushEVSEPricing]]eRoamingPushEVSEPricing
...
== [[PushPricingProductData]]eRoamingPushPricingProductData
