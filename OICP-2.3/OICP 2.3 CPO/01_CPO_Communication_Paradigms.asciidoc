...
Some web service operations that are defined in <<02_CPO_Services_and_Operations,Services and Operations>> together form a functional business process, respectively a functional session.
