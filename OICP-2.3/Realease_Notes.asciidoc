...
== [[OICP2.3ChangesOnEndpoint]]OICP 2.3 Changes on Endpoint
...
=== [[eRoamingChargeDetailRecord]]eRoamingChargeDetailRecord
...
=== [[eRoamingGetChargeDetailRecord]]eRoamingGetChargeDetailRecord
[%header]
|=====
|Change| Field Name| Affected operations/ messages| Change Details
...
=== [[eRoamingChargingNotification]]eRoamingChargingNotification
...
== [[OICP2.3DataTypeChanges]]OICP 2.3 Data Type Changes
...
== [[OICPVersionsCrossFunctional]]OICP Versions - Cross Functional
