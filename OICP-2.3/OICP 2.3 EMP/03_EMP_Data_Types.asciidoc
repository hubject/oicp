...
NOTE: The MeteringSignatureValue format provided `MUST` be supported by the Transparency Software
...
For the full list of active codes of the official https://en.wikipedia.org/wiki/ISO_4217[ISO 4217] currencies
