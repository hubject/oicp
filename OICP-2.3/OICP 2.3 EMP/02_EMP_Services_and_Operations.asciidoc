...
== [[services_and_operations]]Services and Operations
...
== [[eRoamingAuthorization]]eRoamingAuthorization
...
=== [[eRoamingAuthoizeStart]]eRoamingAuthorizeStart_V2.1
...
==== [[eRoamingAuthorizeStartmessage]]eRoamingAuthorizeStart Message
...
=== [[eRoamingAuthorizationStart]]eRoamingAuthorizationStart
[NOTE]
====
- To `SEND`
- Implementation: `MANDATORY`
...
==== [[eRoamingAuthorizationStartmessage]]eRoamingAuthorizationStart Message
...
=== [[eRoamingAuthorizeStop]]eRoamingAuthorizeStop_V2.1
...
==== [[eRoamingAuthorizeStopmessage]]eRoamingAuthorizeStop Message
...
=== [[eRoamingAuthorizationStop]]eRoamingAuthorizationStop
...
==== [[eRoamingAuthorizationStopmessage]]eRoamingAuthorizationStop Message
...
=== [[eRoamingAuthorizeRemoteStart]]eRoamingAuthorizeRemoteStart_V2.1
...
==== [[eRoamingAuthorizeRemoteStartmessage]]eRoamingAuthorizeRemoteStart Message
...
=== [[eRoamingAuthroizeRemoteStop]]eRoamingAuthorizeRemoteStop_V2.1
...
==== [[eRoamingAuthorizeRemoteStopmessage]]eRoamingAuthorizeRemoteStop Message
...
=== [[eRoamingChargeDetailRecord]]eRoamingChargeDetailRecord_V2.2
...
==== [[eRoamingChargeDetailRecordmessage]]eRoamingChargeDetailRecord Message
...
=== [[eRoamingGetChargeDetailRecords]]eRoamingGetChargeDetailRecords_V2.2
[NOTE]
====
- To `SEND`
...
==== [[eRoamingGetChargeDetailRecordsmessage]]eRoamingGetChargeDetailRecords Message
...
== [[eRoamingReservation]]eRoamingReservation
...
=== [[eRoamingAuthorizeRemoteReservationStart]]eRoamingAuthorizeRemoteReservationStart_V1.1
...
==== [[eRoamingAuthorizeRemoteReservationStartmessage]]eRoamingAuthorizeRemoteReservationStart Message
...
=== [[eRoamingAuthorizeRemoteReservationStop]]eRoamingAuthorizeRemoteReservationStop_V1.1
...
==== [[eRoamingAuthorizeRemoteReservationStopmessage]]eRoamingAuthorizeRemoteReservationStopmessage
...
== [[eRoamingAuthenticationData]]eRoamingAuthenticationData
...
=== [[eRoamingPushAuthenticationData]]eRoamingPushAuthenticationData_V2.1
[NOTE]
====
- To `SEND`
- Implementation: `MANDATORY`
...
==== [[eRoamingPushAuthenticationDatamessage]]eRoamingPushAuthenticationData Message
...
== [[eRoamingEvseData]]eRoamingEvseData
...
=== [[eRoamingPullEvseData]]eRoamingPullEvseData_V2.3
...
==== [[eRoamingPullEVSEDatamessage]]eRoamingPullEVSEData Message
...
==== [[eRoamingEVSEDatamessage]]eRoamingEVSEData Message
...
== [[eRoamingEvseStatus]]eRoamingEvseStatus
...
=== [[eRoamingPullEvseStatus]]eRoamingPullEvseStatus_V2.1
...
==== [[eRoamingPullEVSEStatusmessage]]eRoamingPullEVSEStatus Message
...
==== [[eRoamingPullEVSEStatusByIDmessage]]eRoamingPullEVSEStatusByID Message
...
==== [[eRoamingPullEVSEStatusByOperatorIDmessage]]eRoamingPullEVSEStatusByOperatorID Message
...
==== [[eRoamingEVSEStatusmessage]]eRoamingEVSEStatus Message
...
== [[eRoamingDynamicPricing]]eRoamingDynamicPricing
...
=== [[eRoamingPullPricingProductData]]eRoamingPullPricingProductData_V1.0
[NOTE]
====
- To `SEND`
- Implementation: `OPTIONAL`
...
==== [[eRoamingPullPricingProductDatamessage]]eRoamingPullPricingProductData Message
...
==== [[eRoamingPricingProductDatamessage]]eRoamingPricingProductData Message
...
=== [[eRoamingPullEVSEPricing]]eRoamingPullEVSEPricing_V1.0
...
==== [[eRoamingPullEVSEPricingmessage]]eRoamingPullEVSEPricing Message
...
==== [[eRoamingEVSEPricingmessage]]eRoamingEVSEPricing Message
...
== [[eRoamingChargingNotifications]]eRoamingChargingNotifications
[NOTE]
====
- To `RECEIVE`
- Implementation: `OPTIONAL`
...
=== [[eRoamingChargingNotificationsstart]]eRoamingChargingNotifications Start
...
==== [[eRoamingChargingNotificationsstartmessage]]eRoamingChargingNotifications Start Message
...
=== [[eRoamingChargingNotificationsprogress]]eRoamingChargingNotifications Progress
...
==== [[eRoamingChargingNotificationsprogressmessage]]eRoamingChargingNotifications Progress Message
...
=== [[eRoamingChargingNotificationsend]]eRoamingChargingNotifications End
...
==== [[eRoamingChargingNotificationsendmessage]]eRoamingChargingNotifications End Message
...
=== [[eRoamingChargingNotificationsError]]eRoamingChargingNotifications Error
...
==== [[eRoamingChargingNotificationserrormessage]]eRoamingChargingNotifications Error Message
...
== [[eRoamingAcknowledgement]]eRoamingAcknowledgement
